...
var ResettableTimeout = class {
	constructor(onTimeout, timeoutMs) {
		...
		require_objectSpread2._defineProperty(this, "timeout", void 0);
	}
	/**
...
var RequestManager = class {
	constructor() {
		require_objectSpread2._defineProperty(this, "outgoingRequests", new Array());
		require_objectSpread2._defineProperty(this, "pendingRequests", {});
	}
	/**
...
var WsConnection = class WsConnection {
	constructor(opts) {
		...
		require_objectSpread2._defineProperty(this, "id", ++WsConnection.connectCount);
		require_objectSpread2._defineProperty(this, "WebSocketPonyfill", void 0);
		require_objectSpread2._defineProperty(this, "urlOptions", void 0);
		require_objectSpread2._defineProperty(this, "keepAliveOpts", void 0);
		require_objectSpread2._defineProperty(this, "encoder", void 0);
		require_objectSpread2._defineProperty(this, "wsObservable", (0, _trpc_server_observable.behaviorSubject)(null));
		require_objectSpread2._defineProperty(this, "openPromise", null);
...
require_objectSpread2._defineProperty(WsConnection, "connectCount", 0);
/**
...
var WsClient = class {
	constructor(opts) {
		...
		require_objectSpread2._defineProperty(this, "connectionState", void 0);
		require_objectSpread2._defineProperty(this, "allowReconnect", false);
		require_objectSpread2._defineProperty(this, "requestManager", new RequestManager());
		require_objectSpread2._defineProperty(this, "activeConnection", void 0);
		require_objectSpread2._defineProperty(this, "reconnectRetryDelay", void 0);
		require_objectSpread2._defineProperty(this, "inactivityTimeout", void 0);
		require_objectSpread2._defineProperty(this, "callbacks", void 0);
		require_objectSpread2._defineProperty(this, "lazyMode", void 0);
		require_objectSpread2._defineProperty(this, "encoder", void 0);
		require_objectSpread2._defineProperty(this, "reconnecting", null);
		...
		const lazyOptions = require_objectSpread2._objectSpread2(require_objectSpread2._objectSpread2({}, lazyDefaults), opts.lazy);
		...
		this.activeConnection = new WsConnection({
			...
			urlOptions: opts,
			keepAlive: require_objectSpread2._objectSpread2(require_objectSpread2._objectSpread2({}, keepAliveDefaults), opts.keepAlive),
		...
		this.connectionState = (0, _trpc_server_observable.behaviorSubject)({
			type: "state",
	...
	*/
	request({ op: { id, type, path, input, signal }, transformer, lastEventId }) {
		return (0, _trpc_server_observable.observable)((observer) => {
			...
			}, require_objectSpread2._objectSpread2(require_objectSpread2._objectSpread2({}, observer), {}, { next(event) {
				const transformed = (0, _trpc_server_unstable_core_do_not_import.transformResult)(event, transformer.output);
				if (!transformed.ok) {
	...
	reconnect(closedError) {
		...
		const tryReconnect = async (attemptIndex) => {
			try {
				await (0, _trpc_server_unstable_core_do_not_import.sleep)(this.reconnectRetryDelay(attemptIndex));
	...
	*/
	batchSend(message, callbacks) {
		...
		(0, _trpc_server_unstable_core_do_not_import.run)(async () => {
			...
			await (0, _trpc_server_unstable_core_do_not_import.sleep)(0);
